...
function toggleMobileMenu() {
    ...
    // Add mobile search bar if not already present
    if (nav.classList.contains('show') && !document.getElementById('mobile-search-box')) {
        ...
        // Handle RTL styling for mobile search
        ...
        // Enter key listener for mobile search
        mobileInput.addEventListener('keydown', e => {
            if (e.key === 'Enter') doMobileSearch();
        });
    }

    // Remove mobile search when closing
